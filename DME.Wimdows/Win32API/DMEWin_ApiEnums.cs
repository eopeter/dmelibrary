...
namespace DME.Windows.Win32API
{
    ...
    public enum HeaderItemFlags
    {
        ...
        HDI_TEXT = 0x0002,
        HDI_FORMAT = 0x0004,
        HDI_LPARAM = 0x0008, HDI_BITMAP = 0x0010, HDI_IMAGE = 0x0020, HDI_DI_SETITEM = 0x0040, HDI_ORDER = 0x0080
    }
    #endregion
    ...
    public enum StockObjects
    {
        ...
        SYSTEM_FONT = 15,
        //屏幕系统字体。这是用于菜单、对话框等等的默认等宽字体（在windows3.0之前使用）
