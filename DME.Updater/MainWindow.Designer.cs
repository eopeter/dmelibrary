namespace DME.Updater
{
	partial class MainWindow
	{
		...
		private void InitializeComponent()
		{
			...
			this.slideComponent1 = new DME.Updater.Wrapper.SlideComponent();
			this.runUpdate1 = new DME.Updater.UpdateControl.RunUpdate();
			this.updateFinished1 = new DME.Updater.UpdateControl.UpdateFinished();
			this.updateError1 = new DME.Updater.UpdateControl.UpdateError();
			this.noUpdateFound1 = new DME.Updater.UpdateControl.NoUpdateFound();
			this.updateFound1 = new DME.Updater.UpdateControl.UpdateFound();
			this.downloadingInfo1 = new DME.Updater.UpdateControl.DownloadingInfo();
			this.SuspendLayout();
			// 
			// slideComponent1
			// 
			...
			this.slideComponent1.DirectX = DME.Updater.Wrapper.SlideComponent.FlyXDirection.None;
		...
		private DME.Updater.UpdateControl.UpdateFound updateFound1;
		private DME.Updater.Wrapper.SlideComponent slideComponent1;
		private DME.Updater.UpdateControl.UpdateFinished updateFinished1;
		private DME.Updater.UpdateControl.UpdateError updateError1;
		private DME.Updater.UpdateControl.NoUpdateFound noUpdateFound1;
		private DME.Updater.UpdateControl.RunUpdate runUpdate1;
		private DME.Updater.UpdateControl.DownloadingInfo downloadingInfo1;
	}
}