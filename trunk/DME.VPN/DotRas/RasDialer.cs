...
namespace DotRas
{
    ...
    /// </example>
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(RasDialer), "DME.Dialer.DotRas.RasDialer.bmp")]
    public sealed partial class RasDialer : RasComponent
    {
        ...
        public event EventHandler<DME.Dialer.StateChangedEventArgs> StateChanged;
        ...
        public event EventHandler<DME.Dialer.DialCompletedEventArgs> DialCompleted;
        ...
        private void PostCompleted(Exception error, bool cancelled, bool timedOut, bool connected)
        {
            lock (this.syncRoot)
            {
                ...
                {
                    this.asyncOp.PostOperationCompleted(this.dialCompletedCallback, new DME.Dialer.DialCompletedEventArgs(this.handle, error, cancelled, timedOut, connected, null));
        ...
        {
            DME.Dialer.DialCompletedEventArgs e = (DME.Dialer.DialCompletedEventArgs)state;
