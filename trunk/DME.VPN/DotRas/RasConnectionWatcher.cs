...
namespace DotRas
{
    ...
    /// </example>
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(RasConnectionWatcher), "DME.Dialer.DotRas.RasConnectionWatcher.bmp")]
    public sealed partial class RasConnectionWatcher : RasComponent, ISupportInitialize
    {
        ...
        private sealed class RasConnectionWatcherStateObject
        {
            ...
            /// <summary>
            /// Gets or sets the wait object receiving signalling for connection state changes.
            /// </summary>
