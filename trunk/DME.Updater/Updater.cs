...
namespace DME.Updater
{
	...
	public class Updater
	{
		...
		/// 提供一个最简单的自动更新入口
		/// </summary>
		/// <param name="updateUrl">更新URL. 如果不传递或传递空的地址, 请使用 <see cref="T:DME.Updater.UpdateableAttribute"/> 属性来标记更新地址</param>
		...
		/// 下载状态发生变化
		/// </summary>
		public event EventHandler<DME.Updater.Wrapper.RunworkEventArgs> DownloadProgressChanged;
		...
		public void CleanTemp()
		{
			...
			var localpath = Environment.ExpandEnvironmentVariables(@"%TEMP%\DME.Updater.DeleteTmp.exe");
            System.IO.File.WriteAllBytes(localpath, Properties.Resources.DME_Updater_Utilities);
