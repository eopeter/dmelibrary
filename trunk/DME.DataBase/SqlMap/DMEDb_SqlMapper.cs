...
namespace DME.DataBase.DataMap.SqlMap
{
    ...
    public class DMEDb_SqlMapper
    {
        ...
        private DMEDb_CommonDB _DataBase = null;
        private string _ParaChar = null;

        //private string _SqlText;
        private string _SqlMapScript;
        //SQL MAP 脚本
        private DMEDb_ParamMapType[] _ParamsMap;
        ...
        private DMEDb_enumResultClass _ResultClass;
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public DMEDb_enumResultClass ResultClass
        {
        ...
        public string ResultMap
        {
            get
            {
                if (this.ResultClass == DMEDb_enumResultClass.EntityObject)
                {
                    return _ResultMap;
                }
                else
        ...
        /// <remarks></remarks>
        public DMEDb_ParamMapType ParamsMap(int index)
        {
        ...
        /// <remarks></remarks>
        public DMEDb_CommonDB DataBase
        {
        ...
        private DMEDb_DBMSType _dataBaseType = DMEDb_DBMSType.UNKNOWN;
        /// <summary>
        /// 获取或者设置数据库类型
        /// </summary>
        public DMEDb_DBMSType DataBaseType
        {
            get {
                if (_dataBaseType == DMEDb_DBMSType.UNKNOWN)
                {
                    //原始代码：
        ...
        public string SqlMapFile
        {
            get
            {
                ...
                {
                    _SqlMapFile =DME.Base.DME_LibraryConfig.DMEDb_SqlMapFile;
                    if (string.IsNullOrEmpty(_SqlMapFile))
                    {
        ...
        public string  GetScriptInfo(string SqlMapScript)
        {
            ...
            _ParamsMap = new DMEDb_ParamMapType[_ParasLenth];
            return _SqlText;
        ...
        public DMEDb_CommandInfo GetCommandInfo(string XmlCommandName)
        {
            DMEDb_XmlCommand xmlCommand = new DMEDb_XmlCommand(SqlMapFile, this.DataBaseType );
            ...
            DMEDb_CommandInfo cmdInfo = new DMEDb_CommandInfo(this.DataBaseType );
        ...
        private string FindWords(string inputString, int startIndex, int maxLength)
        {
        ...
        /// <returns>命令信息</returns>
        public DMEDb_CommandInfo GetCommandInfoBySqlMapScript(string SqlMapScript)
        {
            DMEDb_CommandInfo cmdInfo = new DMEDb_CommandInfo(this.DataBaseType );
            cmdInfo.ParaChar = this.ParaChar;
            //cmdInfo.CommandType = xmlCommand.CommandType;
        ...
        /// <remarks></remarks>
        public DMEDb_EntityBase ResultMapEntity(IDataReader reader, DMEDb_EntityBase result)
        {
            using (reader)
            {
        ...
        public List<DMEDb_EntityBase> ResultMapEntityList(IDataReader reader, DMEDb_EntityBase result)
        {
            using (reader)
            {
                if (result != null)
                {
                    List<DMEDb_EntityBase> list = new List<DMEDb_EntityBase>();
                    ...
                    if (reader.Read())
                    {
                        ...
                        do
                        {
                            ...
                            DMEDb_EntityBase item = (DMEDb_EntityBase)result.Clone();
