...
namespace DME.DataBase.DataMap.Entity
{
    ...
    /// </summary>
    public class DMEDb_EntityFields
    {
        ...
        {
            DMEDb_EntityBase entity = Activator.CreateInstance(entityType) as DMEDb_EntityBase;
            if (entity != null)
            {
    ...
    {
        private static Dictionary<string, DMEDb_EntityFields> dict = new Dictionary<string, DMEDb_EntityFields>();
        /// <summary>
        /// 获取缓存项，如果没有，将自动创建一个
        /// </summary>
