...
namespace DME.DataBase.DataMap.Entity
{
    ...
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class DMEDb_EntityQuery<T> where T : DMEDb_EntityBase, new()
    {

        /// <summary>
        /// 默认构造函数
        /// </summary>
        public DMEDb_EntityQuery()
        { 
        ...
        public DMEDb_EntityQuery(DMEDb_AdoHelper db)
        {
            DefaultDataBase = db;
        }

        private static DMEDb_EntityQuery<T> _instance;
        /// <summary>
        /// 获取实体查询对象的实例
        /// </summary>
        public static DMEDb_EntityQuery<T> Instance
        {
            get {
                if (_instance == null)
                    _instance = new DMEDb_EntityQuery<T>();
                return _instance;
            }
        }

        private DMEDb_AdoHelper _DefaultDataBase;
        /// <summary>
        ...
        public  bool FillEntity(T entity)
        {
            ...
            sql = sql + string.Join(",", DMEDb_CommonUtil.PrepareSqlFields(entity.PropertyNames)) + " FROM [" + entity.TableName + "] WHERE " + condition.Substring(" AND ".Length);
        ...
        {
            return DMEDb_EntityQuery<T>.Instance.FillEntity(entity); 
        }
        ...
        public static T QueryObject(DMEDb_OQL oql)
        {
            return QueryObject(oql, DMEDb_MyDB.Instance);
        }
        ...
        /// <returns>实体对象</returns>
        public static T QueryObject(DMEDb_OQL oql, DMEDb_AdoHelper db)
        {
            ...
            //}
            //return null;
            return QueryObject(DMEDb_EntityQueryAnonymous.ExecuteDataReader(oql, db, typeof(T), true));
        }
        ...
        /// <returns></returns>
        public static  List<T> QueryList(DMEDb_OQL oql)
        {
            return QueryList(oql, DMEDb_MyDB.Instance);
        }
        ...
        public static List<T> QueryList(DMEDb_OQL oql, DMEDb_AdoHelper db)
        {
            //string sql = "";
            ////处理用户查询映射的实体类
            ...
            //}
            IDataReader reader = DMEDb_EntityQueryAnonymous.ExecuteDataReader(oql, db, typeof(T));
        ...
        public static  string GetMapSql(string fullName,Type entityType)
        {
            ...
            //}
            //return "";
            return DMEDb_EntityQueryAnonymous.GetMapSql(fullName, entityType);
        }
        ...
        {
            DMEDb_AdoHelper db = DMEDb_MyDB.Instance;
            T entity = new T();
            string sql = "SELECT " + string.Join(",", DMEDb_CommonUtil.PrepareSqlFields(entity.PropertyNames)) + " FROM [" + entity.TableName + "]";
       ...
       /// <param name="DB">数据访问对象实例</param>
       /// <returns></returns>
        private static int DeleteInnerByDB(T entity, DMEDb_CommonDB DB)
        {
            if (entity.PrimaryKeys.Count == 0)
                throw new Exception("EntityQuery Error:当前实体类未指定主键字段");
            int fieldCount = entity.PropertyNames.Length;
        ...
        /// <returns>受影响的行数</returns>
        public  int ExecuteOql(DMEDb_OQL oql)
        {
        ...
        /// <param name="db"></param>
        /// <returns></returns>
        public static int ExecuteOql(DMEDb_OQL oql, DMEDb_AdoHelper db)
        {
            string sql = oql.ToString();
        ...
        private static int InsertInner(T entity, List<string> objFields, DMEDb_CommonDB DB)
        {
        ...
        private static int UpdateInner(T entity, List<string> objFields, DMEDb_CommonDB DB)
        {
            if (entity.PrimaryKeys.Count == 0)
                throw new Exception("EntityQuery Error:当前实体类未指定主键字段");
        ...
        public DMEDb_EntityQuery(T entity)
        {
        ...
        public DMEDb_EntityQuery(T entity,bool newEntity)
        {
            isNew = newEntity;
            init(entity);
        }
        ...
        /// <param name="fields">实体类属性值列表</param>
        /// <returns>操作数据库影响的行数</returns>
        public int Save(DMEDb_CommonDB db, params object[] fields)
        {
        ...
        public int SaveAllChanges(DMEDb_CommonDB db)
        {
            //List<string> list = new List<string>();
        ...
        private int InnerSaveAllChanges(DMEDb_CommonDB db, List<string> objFields)
        {
            int count = 0;
            if (objFields.Count == 0)
                return 0;
        ...
        /// <param name="db"></param>
        /// <returns></returns>
        public int Delete(T entity, DMEDb_CommonDB db)
        {
        ...
        public int Update(T entity, DMEDb_CommonDB db)
        {
            T temp = new T();
        ...
        /// <param name="db">数据库对象</param>
        /// <returns>返回操作受影响的行数</returns>
        public int Insert(T entity, DMEDb_CommonDB db)
        {
            int fieldCount = entity.PropertyNames.Length;
            if (fieldCount == 0)
                throw new Exception("EntityQuery Error:实体类属性字段数量为0");
