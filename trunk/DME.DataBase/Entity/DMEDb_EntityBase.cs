...
namespace DME.DataBase.DataMap.Entity
{
    ...
    public abstract class DMEDb_EntityBase : INotifyPropertyChanged, ICloneable, DME.DataBase.Common.DMEDb_IEntity
    {
        /*
        * 为了更加减少内存垃圾回收,使用下面的方式在实体类进行初始化,需要修改代码生成器
        
        */
        private DME.DataBase.Common.DMEDb_EntityMapType _entityMap = DME.DataBase.Common.DMEDb_EntityMapType.Table;
        /// <summary>
        /// 实体类的映射类型
        /// </summary>
       ...
       /// <returns>属性值</returns>
        ...
        public string TableName
        {
            ...
            get {
                if (EntityMap == DMEDb_EntityMapType.SqlMap)
                {
        ...
        {
            this.OnPropertyGeting(propertyName);
            return DMEDb_CommonUtil.ChangeType<T>(PropertyList(propertyName));
        }
