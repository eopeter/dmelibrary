...
namespace DME.DataBase.DataProvider.Data
{
    ...
    /// 查询异常类
    /// </summary>
    public  class DMEDb_QueryException:Exception 
    {
        private string _sql;
        /// <summary>
        /// SQL
        ...
        /// 默认构造函数
        /// </summary>
        public DMEDb_QueryException(string message)
            : base(message)
        { }
        ...
        public DMEDb_QueryException(string message, string sql, CommandType cmdType, IDataParameter[] parameters,bool inTransaction,string connectionString):base(message)
        {
            //_message = message;
            this.Sql = sql;
