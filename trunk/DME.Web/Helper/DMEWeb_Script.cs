...
namespace DME.Web.Helper
{
    public class DMEWeb_Script
    {
        ...
        /// 代码调用:
        /// Response.Write(DMEWeb_Script.BaseUrl);
        /// </summary>
        ...
        /// 简单的滚动信息栏
        /// 代码调用
        ///         DMEWeb_Script.ScrollMessage(this.Page, "滚动的内容");
        /// </summary>
        /// <param name="pageCurrent">
        /// 当前页面
        /// </param>
        ...
        /// Modified: GuangMing Chu 1,1,2007
        /// 代码调用：
        ///    DMEWeb_Script.AddConfirm(this.Button1, "真的要删了？？");
        ...
        /// 代码调用：
        ///         DMEWeb_Script myHelp = new DMEWeb_Script();
        ...
        /// 代码调用
        ///         DMEWeb_Script.AddShowDialog(this.Button1, "www.sina.com.cn", 300, 300);
        /// 
        /// 
        /// 
        /// </summary>
        ...
        /// 
        /// 
        ///         DMEWeb_Script.OpenWindow(this.Page, "www.sina.com.cn", 400, 300);
        ///         DMEWeb_Script.ShowDialog(this.Page, "lsdjf.com", 300, 200);
        /// 
        /// 
        /// 
        /// </summary>
        ...
        /// 放入page_load事件中
        ///            DMEWeb_Script myUI = new DMEWeb_Script();
        ...
        public static string Page_revealTrans(System.Web.UI.Page currentPage, string duration, string transition)
        {
            StringBuilder sb = new StringBuilder();
