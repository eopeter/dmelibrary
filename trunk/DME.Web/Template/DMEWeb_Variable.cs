...
namespace DME.Web.Template
{
    ...
    /// 变量
    /// </summary>
    public class DMEWeb_Variable : DMEWeb_ICloneableElement<DMEWeb_Variable>
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        internal DMEWeb_Variable(DMEWeb_Template ownerTemplate, string name)
        {
        ...
        /// <param name="ownerTemplate"></param>
        /// <returns></returns>
        public DMEWeb_Variable Clone(DMEWeb_Template ownerTemplate)
        {
            return new DMEWeb_Variable(ownerTemplate, this.Name);
        }
        #endregion
    }
}
