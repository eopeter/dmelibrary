...
namespace DME.Web.Template
{
    ...
    /// </summary>
    public class DMEWeb_ForTag : DMEWeb_Tag
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="ownerTemplate"></param>
        internal DMEWeb_ForTag(DMEWeb_Template ownerTemplate)
            : base(ownerTemplate)
        {}
        ...
        /// 索引变量
        /// </summary>
        public DMEWeb_VariableIdentity Index { get; protected set; }
        #endregion
        ...
        internal override bool ProcessBeginTag(DMEWeb_Template ownerTemplate, DMEWeb_Tag container, Stack<DMEWeb_Tag> tagStack, string text, ref Match match, bool isClosedTag)
        {
            ...
            if (this.To == null) throw new DMEWeb_ParserException(string.Format("{0}标签中缺少to属性", this.TagName));
        ...
        {
            DMEWeb_ForTag tag = new DMEWeb_ForTag(ownerTemplate);
            base.CopyTo(tag);
