...
namespace DME.Base.Network.Sockets
{
    ...
    /// </remarks>
    public abstract class DME_NetServer : DME_Netbase
    {
        #region 属性
        ...
        private DME_SocketServer _Server;
        /// <summary>服务器</summary>
        public DME_SocketServer Server
        {
            get { return _Server; }
            set { _Server = value; }
        }
        ...
        protected virtual void OnStart()
        {
            ...
            Server.Error += new EventHandler<DME_NetEventArgs>(OnError);
            Server.Start();
        ...
        /// <param name="e"></param>
        protected virtual void OnError(object sender, DME_NetEventArgs e)
        {
