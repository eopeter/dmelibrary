...
namespace DME.Base.IO
{
    ...
    /// 二进制数据访问器
    /// </summary>
    public class DME_BinaryAccessor : DME_IBinaryAccessor
    {
        #region 读写
        /// <summary>
        /// 从读取器中读取数据到对象
        ...
        #region 辅助
        static DME_DictionaryCache<Type, FieldInfo[]> cache1 = new DME_DictionaryCache<Type, FieldInfo[]>();
        /// <summary>
        /// 取得所有可序列化字段
        /// </summary>
        /// <param name="type"></param>
        ...
        static DME_DictionaryCache<Type, PropertyInfo[]> cache2 = new DME_DictionaryCache<Type, PropertyInfo[]>();
        /// <summary>
        /// 取得所有属性
        /// </summary>
        /// <param name="type"></param>
