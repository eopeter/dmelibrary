...
namespace DME.Base.Reflection
{
    ...
    /// 快速访问成员
    /// </summary>
    public abstract class DME_MemberInfo
    {
        #region 属性
        ...
        protected DME_MemberInfo(MemberInfo member) { Member = member; }
        #endregion
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public static implicit operator MemberInfo(DME_MemberInfo obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public static implicit operator DME_MemberInfo(MemberInfo obj)
        {
            ...
            switch (obj.MemberType)
            {
                ...
                case MemberTypes.Event:
                    break;
                case MemberTypes.Field:
                    return DME_FieldInfo.Create(obj as FieldInfo);
                case MemberTypes.Method:
                    return DME_MethodInfo.Create(obj as MethodInfo);
                case MemberTypes.NestedType:
                    break;
                case MemberTypes.Property:
                    return DME_PropertyInfo.Create(obj as PropertyInfo);
                case MemberTypes.TypeInfo:
                    break;
                default:
                    break;
