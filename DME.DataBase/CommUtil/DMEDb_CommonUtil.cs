...
namespace DME.DataBase
{
    /// <summary>
    /// 通用方法类
    /// </summary>
    public class DMEDb_CommonUtil
    {
       /// <summary>
       ...
       {
           if (!DME.Base.Helper.DME_Validation.IsNull(sourcePath) && sourcePath.IndexOf('~') >=0)
           {
               string appRootPath = DME.Base.Helper.DME_Path.MapPath("/");
               sourcePath = sourcePath.Replace("~", appRootPath.Substring(0, appRootPath.Length-1));
           }
       }
