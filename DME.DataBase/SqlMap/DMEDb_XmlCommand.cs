...
namespace DME.DataBase.DataMap.SqlMap
{
    ...
    public class DMEDb_XmlCommand
    {
        ...
        private DMEDb_DBMSType _ScriptType;
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public DMEDb_DBMSType ScriptType
        {
            ...
            try
            {
                ...
                if (_SqlTextPath.StartsWith("@R://"))
                {
                    ...
                    else
                    {
                        ...
                        //xmlString = sr.ReadToEnd();
                        //sr.Close();
                        xmlString = DME.DataBase.DMEDb_CommonUtil.GetAssemblyResource(source[0], source[1]);
