...
namespace DME.Web.Template
{
    ...
    /// </summary>
    public class DMEWeb_ForEachTag : DMEWeb_Tag
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// 来源数据的变量
        /// </summary>
        public DMEWeb_VariableExpression From { get; protected set; }
        /// <summary>
        /// 当前项变量
        /// </summary>
        public DMEWeb_VariableIdentity Item { get; protected set; }
        /// <summary>
        /// 索引变量
        /// </summary>
        ...
        /// 分组大小
        /// </summary>
        public DMEWeb_Attribute GroupSize
        {
            get
            {
        ...
        /// ForEachElse节点
        /// </summary>
        private DMEWeb_ForEachElseTag _Else;
        /// <summary>
        /// ForEachElse节点
        /// </summary>
        public DMEWeb_ForEachElseTag Else
        {
            get { return _Else; }
            internal set
            {
