...
namespace DME.Web.Template
{
    ...
    /// 解析模板时的错误
    /// </summary>
    public class DMEWeb_ParserException : Exception
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="message">描述信息</param>
        public DMEWeb_ParserException(string message)
            : base(message)
        {
        ...
        /// <param name="message">描述信息</param>
        public DMEWeb_ParserException(Point p, string text, string message)
        ...
        /// <param name="text">模板文本数据</param>
        /// <param name="message">描述信息</param>
        public DMEWeb_ParserException(int line, int column, string text, string message)
        ...
        /// <param name="text">模板文本数据</param>
        /// <param name="message">描述信息</param>
        public DMEWeb_ParserException(string fileName, Point p, string text, string message)
        ...
        /// <param name="text">模板文本数据</param>
        /// <param name="message">描述信息</param>
        public DMEWeb_ParserException(string fileName, int line, int column, string text, string message)
