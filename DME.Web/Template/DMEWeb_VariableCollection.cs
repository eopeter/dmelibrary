...
namespace DME.Web.Template
{
        ...
        : IEnumerable<DMEWeb_Variable>
    {
        ...
        {
            _Dictionary = new Dictionary<string, DMEWeb_Variable>(StringComparer.InvariantCultureIgnoreCase);
        }
        ...
        {
            _Dictionary = new Dictionary<string, DMEWeb_Variable>(capacity, StringComparer.InvariantCultureIgnoreCase);
        }

        /// <summary>
        /// 存放容器
        /// </summary>
        private Dictionary<string, DMEWeb_Variable> _Dictionary;
        ...
        public DMEWeb_Variable this[int index]
        {
            get
            {
                if (index >= 0 && index < _Dictionary.Count)
                {
                    IEnumerator<DMEWeb_Variable> enumer = _Dictionary.Values.GetEnumerator();
                    int i = 0;
        ...
        public DMEWeb_Variable this[string name]
        {
            get
            {
                if (string.IsNullOrEmpty(name)) return null;

                DMEWeb_Variable value;
        ...
        internal void Add(DMEWeb_Variable item)
        {
            if (item == null) return;
        ...
        public void SetValue(string varExp, object value)
        {
            ...
            DMEWeb_Variable var = this[exps[0]];
            if (var != null)
            {
                if (exps.Length == 1)
                {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerator<DMEWeb_Variable> GetEnumerator()
        {
