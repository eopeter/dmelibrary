...
namespace DME.Web.Template
{
    ...
    /// 服务器数据类型
    /// </summary>
    public enum DMEWeb_ServerDataType
    {
        /// <summary>
        /// 未知
        /// </summary>
    ...
    /// </summary>
    public class DMEWeb_ServerDataTag : DMEWeb_Tag
    {
        /// <summary>
        /// 随机种子数
        /// </summary>
        ...
        internal DMEWeb_ServerDataTag(DMEWeb_Template ownerTemplate)
            : base(ownerTemplate)
        {
        }
        ...
        {
            DMEWeb_ServerDataTag tag = new DMEWeb_ServerDataTag(ownerTemplate);
            this.CopyTo(tag);
        ...
        {
            DMEWeb_ServerDataType type = (DMEWeb_ServerDataType)DMEWeb_Utility.ConvertTo(this.Type.GetTextValue(), typeof(DMEWeb_ServerDataType));
            switch (type)
            {
                case DMEWeb_ServerDataType.Time:
                    return GetServerTime();
                case DMEWeb_ServerDataType.Random:
                    return random.NextDouble();
                case DMEWeb_ServerDataType.Application:
                    return GetApplicationItem();
                case DMEWeb_ServerDataType.Session:
                    return GetSessionItem();
                case DMEWeb_ServerDataType.Cache:
                    return GetCacheItem();
                case DMEWeb_ServerDataType.QueryString:
                    return GetRequestQueryStringItem();
                case DMEWeb_ServerDataType.Form:
                    return GetRequestFormItem();
                case DMEWeb_ServerDataType.Cookie:
                    return GetCookieItem();
                case DMEWeb_ServerDataType.ServerVariables:
                    return GetRequestServerVariablesItem();
                case DMEWeb_ServerDataType.RequestParams:
                    return GetRequestParamsItem();
                case DMEWeb_ServerDataType.Request:
                    return GetRequestItem();
                case DMEWeb_ServerDataType.Environment:
                    return typeof(System.Environment);
                case DMEWeb_ServerDataType.AppSetting:
