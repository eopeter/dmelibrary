...
namespace DME.Web.Template
{
    ...
    public class DMEWeb_ElementCollection<T> : IEnumerable<T> 
    {
        /// <summary>
        /// 存储空间
        /// </summary>
        ...
        /// 构造默认的集合
        /// </summary>
        internal DMEWeb_ElementCollection()
        {
            _List = new List<T>();
        }
        /// <summary>
        ...
        internal DMEWeb_ElementCollection(int capacity)
        {
        ...
        internal DMEWeb_ElementCollection(IEnumerable<T> collection)
        {
