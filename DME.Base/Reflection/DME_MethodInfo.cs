...
namespace DME.Base.Reflection
{
    ...
    /// </summary>
    public class DME_MethodInfo : DME_MemberInfo
    {
        #region 属性
        ...
        #region 构造
        private DME_MethodInfo(MethodInfo method) : base(method) { Method = method; }

        private static Dictionary<MethodInfo, DME_MethodInfo> cache = new Dictionary<MethodInfo, DME_MethodInfo>();
        /// <summary>
        /// 创建
        /// </summary>
        /// <param name="method"></param>
        /// <returns></returns>
        public static DME_MethodInfo Create(MethodInfo method)
        {
            ...
            lock (cache)
            {
                ...
                DME_MethodInfo entity = new DME_MethodInfo(method);
        ...
        /// <returns></returns>
        public static DME_MethodInfo Create(Type type, String name)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public static implicit operator MethodInfo(DME_MethodInfo obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public static implicit operator DME_MethodInfo(MethodInfo obj)
        {
