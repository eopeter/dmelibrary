...
namespace DME.Base.Reflection
{
    ...
    /// 快速属性访问
    /// </summary>
    public class DME_PropertyInfo : DME_MemberInfo
    {
        #region 属性
        ...
        #region 构造
        private DME_PropertyInfo(PropertyInfo property) : base(property) { Property = property; }

        private static Dictionary<PropertyInfo, DME_PropertyInfo> cache = new Dictionary<PropertyInfo, DME_PropertyInfo>();
        /// <summary>
        /// 创建
        /// </summary>
        /// <param name="property"></param>
        /// <returns></returns>
        public static DME_PropertyInfo Create(PropertyInfo property)
        {
            ...
            lock (cache)
            {
                ...
                DME_PropertyInfo entity = new DME_PropertyInfo(property);
        ...
        /// <returns></returns>
        public static DME_PropertyInfo Create(Type type, String name)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public static implicit operator PropertyInfo(DME_PropertyInfo obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public static implicit operator DME_PropertyInfo(PropertyInfo obj)
        {
