...
namespace DME.Base.Network.Tcp
{
    ...
    /// TCP服务器
    /// </summary>
    public class DME_TcpServer : DME_SocketServer
    {
        #region 属性
        /// <summary>
        /// 已重载。
        ...
        /// 构造TCP服务器对象
        /// </summary>
        public DME_TcpServer() : base(IPAddress.Any, 0) { }

        /// <summary>
        /// 构造
        /// </summary>
        /// <param name="port"></param>
        public DME_TcpServer(Int32 port) : base(IPAddress.Any, port) { }
        ...
        /// <param name="port"></param>
        public DME_TcpServer(IPAddress address, Int32 port) : base(address, port) { }
        ...
        /// <param name="port"></param>
        public DME_TcpServer(String hostname, Int32 port) : base(hostname, port) { }
        #endregion
        ...
        /// </summary>
        public event EventHandler<DME_NetEventArgs> Accepted;

        /// <summary>
        /// 新客户端到达
        /// </summary>
        /// <param name="e"></param>
        protected virtual void OnAccept(DME_NetEventArgs e)
        {
            // 再次开始
            ...
            // 建立会话
            DME_TcpSession session = CreateSession(e);
        ...
        #region 会话
        private DME_TcpSessionCollection _Sessions;
        /// <summary>会话集合</summary>
        public DME_TcpSessionCollection Sessions
        {
            get { return _Sessions ?? (_Sessions = new DME_TcpSessionCollection()); }
        }
        ...
        /// <param name="e"></param>
        /// <returns></returns>
        protected virtual DME_TcpSession CreateSession(DME_NetEventArgs e)
        {
            DME_TcpSession session = new DME_TcpSession();
