...
namespace DME.Base.Network.IO
{
    ...
    public class DME_FileFormat
    {
        ...
        public DME_FileFormat(String fileName, String root)
        {
        ...
        /// <param name="stream"></param>
        /// <returns></returns>
        public static DME_FileFormat Load(Stream stream)
        {
            DME_FileFormat ff = new DME_FileFormat();
            ff.Read(stream);
            return ff;
        }
