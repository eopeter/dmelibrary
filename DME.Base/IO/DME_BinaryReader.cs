...
namespace DME.Base.IO
{
    ...
    /// 二进制协议读取器
    /// </summary>
    public class DME_BinaryReader : BinaryReader
    {
        /// <summary>
        /// 构造
        /// </summary>
        /// <param name="stream"></param>
        public DME_BinaryReader(Stream stream) : base(stream) { }
        ...
        private Boolean ReadX(Type type, out Object value)
        {
            ...
            value = DME_MethodInfo.Create(method).Invoke(this, new Object[0]);
            return true;
        }
