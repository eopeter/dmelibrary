...
namespace DotRas.Internal
{
    ...
    internal static class NativeMethods
    {
        ...
        /// <summary>
        /// Defines the done state for a RAS connection substate.
        /// </summary>
        ...
        public enum RASIKEV2
        {
            ...
            /// <summary>
            /// The client supports the IKEv2 Mobility and Multihoming (MOBIKE) protocol.
            /// </summary>
            MobileIke = 0x1,
        ...
        /// </summary>
        /// <remarks>This structure does not match the SDK due to a union on the object. See the implementation for additional details.</remarks>
        [StructLayout(LayoutKind.Sequential)]
